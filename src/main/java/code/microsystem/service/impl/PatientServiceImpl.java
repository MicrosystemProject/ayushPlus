...
public class PatientServiceImpl implements PatientService {
	...
	public Patient addPatient(PatientRequest patientRequest) {
		Patient patientObj = Patient.builder().firstName(patientRequest.getFirstName())
				.middleName(patientRequest.getMiddleName()).lastName(patientRequest.getLastName())
				.age(patientRequest.getAge()).dob(patientRequest.getDob()).gender(patientRequest.getGender())
	...
	public Patient editPatient(PatientRequest patientRequest) throws PatientNotFoundException {
		Patient patient = patientRepository.findById(patientRequest.getPId()).orElseThrow(
				() -> new PatientNotFoundException("Patient not found with id: " + patientRequest.getPId()));
	...
	public Patient getPatientById(int pId) throws PatientNotFoundException {
		return patientRepository.findById(pId)
				.orElseThrow(() -> new PatientNotFoundException("Patient not found with ID: " + pId));
